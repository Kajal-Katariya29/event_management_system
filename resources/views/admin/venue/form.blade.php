<div class="row mt-5">
    <div class="col-6 mt-2">
        ...
        {!! Form::select('country_id',$country_id, null, ['placeholder' => 'Select Country...', 'class' => 'form-select mt-2 selectCountry', 'id' => 'selectCountry']) !!}
        {!! $errors->first("country_id",'<span class="text-danger">:message</span>') !!}
    </div>
    <div class="col-6 mt-2">
        {!! Form::label("city_id", "Select City Name: ") !!}
        {!! Form::select('city_id',$city_id , null, ['placeholder' => 'Select City...', 'class' => 'form-select mt-2','id' => 'city']) !!}
    ...
    <div class="col-12 mt-3">
        ...
        {!! Form::number("capacity", null, ['class' => 'form-control capacity', 'id' => 'capacity']) !!}
        {!! $errors->first("capacity",'<span class="text-danger">:message</span>') !!}
    </div>
    <div class="mt-3">
